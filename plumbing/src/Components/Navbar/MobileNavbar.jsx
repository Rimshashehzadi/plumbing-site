        ...
        <div className="px-6 py-6">
                ...
                {item.subMenu ? (
                  <>
                    <button
                      ...
                      className="flex w-full items-center justify-between py-2 text-lg font-medium text-white hover:text-white"
                    >
                      <span>{item.name}</span>
                  ...
                  <Link
                    to={item.path}
                    onClick={() => setIsMenuOpen(false)}
                    className="flex items-center justify-between py-3 text-lg font-medium text-white hover:text-white"
                  >
                    {item.name}
                    <ArrowRight size={16} />
                  </Link>
          ...
          <div className="mt-8">
            <Link
              to="/signup"
              onClick={() => setIsMenuOpen(false)}
              className="flex w-full items-center justify-center rounded-lg hover:text-white hover:bg-primary bg-white px-6 py-3 text-lg font-semibold text-primary transition duration-300 hover:bg-gray-100"
            >
              Connect
            </Link>
          </div>
